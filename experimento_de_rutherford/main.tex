...
\twocolumn[
  \begin{@twocolumnfalse}
    ...
    En este trabajo presentamos una descripción detallada del experimento de dispersión de Rutherford por medio de una simulación de partículas alpha colisionando con una hoja delgada de oro. Describimos las ecuaciones que rigen la dispersión de partículas alfa y calculamos una cota superior para el átomo de oro.
    \end{minipage}
    \end{center}
    \end{abstract}
  \end{@twocolumnfalse}
